...
using SistemaCompra.Infra.Data.ItemCompra;
...
namespace SistemaCompra.Infra.Data
{
    public class SistemaCompraContext : DbContext
    {
        ...
        public DbSet<SolicitacaoAgg.ItemCompra> ItemCompras { get; set; }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            optionsBuilder.UseLoggerFactory(loggerFactory)  
                ...
                .UseSqlServer(@"Server=localhost,1433;Database=SistemaCompraDb; User Id=sa; Password=Wdaqwe123*;TrustServerCertificate=true");
        }
    }
}
